...
<div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
  <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="toast-header">
      ...
      <strong class="me-auto">Se subio Correctamente el archivo</strong>
      <a href="index.php"><button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button></a>
    </div>
    <div class="toast-body">
      <h6 class="text-center msjexito">Acta Registrada con Exito</h6>
    </div>
  </div>
</div>
<?php } ?>
